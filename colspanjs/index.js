...
for(const e of DataArray) //végigiterálunk a DataArray Arrayen
{
     ...
     */
    let row = e.Author+'|'+e.Creation+'|'+ e.FirstConcept+'|' //egy változóba beletesszük a sor első három elemét, az e-ben jelenleg tárolt objektum elemeit
    if (e.SecondConcept != undefined) //megnézzük hogy a második fogalom az undefined-e
    {
        row+= e.SecondConcept +'|' //igaz ág, hozzáadjuk a második fogalmat a sorhoz
    }
    else //hamis ág
    {
        row+= '|' //üres részt hozzáadjuk a sorhoz
    }
